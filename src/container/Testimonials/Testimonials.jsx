...
const Testimonials = () => {
  ...
  useEffect(() => {
    ...
    client.fetch(query)
    .then( (data) => {
      // console.log(data, 'testimonials data ')
...
//to avoid retyping test, assign it to a variable then reuse the variable
  ...
  return (
    ...
    {testimonials.length && (
      ...
      <div className='app__testimonial-item app__flex'>
        ...
        {/* changed imgurl to ---imageurl---  , this solves it */}
...
{/* div to allow us to move from different testimonials */}
